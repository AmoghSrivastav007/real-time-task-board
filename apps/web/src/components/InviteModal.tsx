...
export default function InviteModal({ boardId, onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl mx-4">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800">
          <h2 className="text-white font-semibold">Invite to Board</h2>
